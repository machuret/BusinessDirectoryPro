...
export async function createServicesTablesDirect() {
  console.log("Creating services tables with direct SQL...");
  ...
  try {
    ...
    console.log("Services tables created successfully with direct SQL!");
    return { success: true };

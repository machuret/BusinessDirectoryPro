...
export default function AdminSocialMedia() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    createMutation.mutate({
      ...
      url: formData.url,
      iconClass: formData.iconClass || `fab fa-${formData.platform}`,
      displayName: formData.displayName || formData.platform,
  ...
  const handleUpdate = (e: React.FormEvent) => {
    e.preventDefault();
    if (editingId && formData.platform && formData.url) {
                ...
                <form onSubmit={handleUpdate} className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input value={formData.platform} readOnly />
                    </div>
                    <div>
                      <Label>URL</Label>
                      <Input
